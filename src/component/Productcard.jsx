...
const Productcard = (props) => {
  return (
    <div className='w-[12em] h-[41vh] flex flex-col items-center px-4 py-4 rounded-lg border border-[#E5E5E5] '>
      ...
      <div className='flex flex-col items-start justify-between h-full w-full'> 
       ...
       <p className='text-neutral-500 text-sm'>{props.data.quantity}</p>
